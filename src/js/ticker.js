...
!(function (a, b, c, d) {
  a.fn.jConveyorTicker = function (b) {
    ...
    var c = { anim_duration: 200, reverse_elm: !1, force_loop: !1 },
      d = c.anim_duration,
      e = c.reverse_elm,
      f = c.force_loop;
    b &&
      (void 0 !== b.anim_duration && (d = b.anim_duration),
      void 0 !== b.reverse_elm && (e = b.reverse_elm),
      void 0 !== b.force_loop && (f = b.force_loop),
      a.extend(c, b)),
      this.each(function () {
        var b = a(this),
          c = b.children("ul");
        c.css({ margin: "0", padding: "0", "list-style": "none" })
          .children("li")
          .css({ display: "inline-block" });
        var g = c.width(),
          h = c.parent().width(),
          i = h / 2 - 20;
        c.removeAttr("style").children("li").removeAttr("style"),
          b.addClass("jctkr-wrapper");
        var j = function () {
          ...
          var h = function (a) {
            ...
            if (void 0 !== a && "reverse" === a) {
              if (((b = e / 2), f > 0))
                return c.css("left", "-" + b + "px"), void h("reverse");
              (g = "+"), (i = "reverse");
            } else if (((b = (e / 2) * -1), f < b)) {
              var j = -1 * (b - f);
              return c.css("left", j + "px"), void h(i);
            }
            c.animate({ left: g + "=10px" }, d, "linear", function () {
              h(i);
            });
          };
          b.hover(
